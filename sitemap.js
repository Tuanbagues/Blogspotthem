...
// Url: https://blogtuanbagues.blogspot.com
// Source: http://www.tuanbagues.web.id
// ---------------------------------------------------
...
// this function creates a three-column table and adds it to the screen
   ...
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (menurun secara bertahap)';
      tocTool2 += ' (terbaru)';
   }
   if (sortBy == "titledesc") { 
      tocTool1 += ' (meningkat secara bertahap)';
      tocTool2 += ' (terbaru)';
   }
   ...
   if (postFilter != '') {
      tocTool3 = 'Klik untuk menampilkan semua artikel website www.blogtuanbagues.blogspot.com';
   }
   tocTable += '<table>';
   tocTable += '<tr>';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Tunjukkan semuanya' + postTitle.length + ' artikel<br/><br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Menunjukkan ' + numDisplayed + ' Postingan dengan label \'';
      tocNote += postFilter + '\' Total'+ postTitle.length + ' Artikel<br/><br/></span>';
   }
